	   ...
	   <section>
    		<h2>Structure Search</h2>
    	     ...
    	     <h3>Substructure Search</h3>    			
				...
				<br/><b>NOTE:</b> The exact search only works for SMILES and MOL formats.				
				<br/><br/>
            <b>Select one option:</b><br/> 
		        ...
		        <script type="text/javascript" SRC="<?=$app2base?>applets/marvin/marvin.js"></script>
					...
					<form name="marSketchSub" method="get" action="substructure_results.php" class="formulario">
							<input type="text" style="display:none" id="marSmartsSub" name="chemical" size="50"><br/><br/>
						1. Select one kind of search:
						...
						<input type="hidden" name="format" id="formSpecialSub" value="SMARTS"/>					
      		...
      		<div style="display:none" id="entrada">
				...
				<form name="rdkit" method="get" action="substructure_results.php" class="formulario">
					2. Select one kind of search:
					<input type="radio" name="match" checked="checked" id="sub" value="subs"/> Substructure
					<input type="radio" name="match" id="ex" value="exact"/> Exact<br/><br/>				
					3. Enter the string of characters (for <b>SMILES</b> queries): <input type="text" name="chemical" value="Oc1ccc(\C=C\C=O)cc1O" size="50"/><br/><br/>
				...
				<form name="smarts" method="get" action="substructure_results.php" class="formulario">
					<input type="hidden" name="match" value="subs"/>
			...
			<form name="molfile" method="post" action="substructure_results.php" enctype="multipart/form-data" class="formulario">	
				2. Select one kind of search:
					<input type="radio" name="match" checked="checked" id="sub" value="subs"/> Substructure
					<input type="radio" name="match" id="ex" value="exact"/> Exact<br/><br/>	
				3. Select a <b>MOL</b> file from your computer: <input type="file" name="datafile" id="datafile" size="40"/><br/><br/>
             ...
             <b>Select one option:</b><br/> 
				...
				<input type="radio" name="chemblSim" id="chemblSim2" value="No" onchange="Sim();"/> Input an string or a molfile stored in your computer 
             </p>
			...
			<div style="display:none; text-align:center;" id="marvinSim">
		      <script type="text/javascript" SRC="<?=$app2base?>applets/marvin/marvin.js"></script>
				...
				<form name="marSketchSim" method="get" action="similarity_results.php" class="formulario">
						<input type="text" style="display:none" id="marSmartsSim" name="chemical" size="50"><br/><br/>
						1. Select one kind of fingerprints (Morgan (ECFP-like) by default): 
			...
			<p>
			1. Please select one of the following formats for the input: 
				<select name="format" id="formatSim" onclick="Simstring();">
					<option value="None" selected="selected" class="listheader">---</option>				
				...
				<form name="rdkit" method="get" action="similarity_results.php" class="formulario">
					...
					4. Enter the string of characters (for <b>SMILES</b> queries): <input type="text" name="chemical" value="CC1=CC(C)(C)Nc2cc3oc(=O)cc(C(F)(F)F)c3cc21" size="50"><br/><br/>
					<input type="hidden" name="format" value="SMILES"/>
					<input type="submit" name="accion" value="Run SMILES" id="runDisplay">
				</form>
				</div>
				...
				<form name="smarts" method="get" action="similarity_results.php" class="formulario">	
					2. Select one kind of fingerprints (Morgan (ECFP-like) by default): 
					<select name="fingerprint" id="fingerprint">
						<option value="Morgan" selected="selected" class="listheader">Morgan</option>				
						<option value="MorganFeat" class="listheader">Morgan features</option>
					...
					4. Enter the string of characters (for <b>SMARTS</b> queries): <input type="text" name="chemical" value="[#6;X4]-1-[#6](=[#8])-[#7]-[#7]-[#6]-1=[#8]" size="50"><br/><br/>
					<input type="hidden" name="format" value="SMARTS"/>
					<input type="submit" name="accion" value="Run SMARTS" id="runDisplay">
				</form>
				</div>		
			...
			<form name="molfile" method="post" action="similarity_results.php" enctype="multipart/form-data" class="formulario">
				2. Select one kind of fingerprints (Morgan (ECFP-like) by default): 
					<select name="fingerprint" id="fingerprint">
						<option value="Morgan" selected="selected" class="listheader">Morgan</option>				
						<option value="MorganFeat" class="listheader">Morgan features</option>
				...
				4. Select a <b>MOL</b> file from your computer: <input type="file" name="datafile" id="datafile" size="40"><br/><br/>
				<input type="hidden" name="format" value="MOL"/>
				<input type="submit" name="accion" value="Run MOL" id="runDisplay">
			</form>
			</div> 			
