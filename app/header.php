...
<head>
  ...
  <title>Open ChEMBL</title>
  <meta name="description" content="Open ChEMBL">
  ...
  <div id="wrapper" class="container_24">
    <header>
		...
		<div id="local-masthead" class="masthead grid_24 nomenu">
			...
			<div id="local-title">
				<h1>Open ChEMBL <img src="<?=$app2base?>static/images/app/chembl_symbol.png" width="5%" height="5%"></h1>		
			</div>
